...
<?php $message = Session::instance()
                        ->get_once('message', false); ?>
<?php if ($message)
{ ?>
...
<div>
    <?php echo HTML::anchor(
        Route::get('migrations_new')
             ->uri(), 'Generate NEW migration'
    ) ?>
</div>
<br>
...
<div>
    <?php echo HTML::anchor(
        Route::get('migrations_migrate')
             ->uri(), 'RUN ALL PENDING MIGRATIONS'
    ) ?>
</div>

<div>
    <?php echo HTML::anchor(
        Route::get('migrations_rollback')
             ->uri(), 'ROLLBACK'
    ) ?>
</div>
