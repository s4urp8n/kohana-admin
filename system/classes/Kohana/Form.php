...
class Kohana_Form
{
    ...
    public static function select(
        $name, array $options = null, $selected = null, array $attributes = null, $optionAttrsGenerator = null
    ) {
        // Set the input name
        $attributes['name'] = $name;
            ...
            foreach ($options as $value => $name)
            {
                if (is_array($name))
                {
                    ...
                    foreach ($name as $_value => $_name)
                    {
                        ...
                        $_options[] = '<option ' . (is_null($optionAttrsGenerator)
                                ? ''
                                : HTML::attributes($optionAttrsGenerator($_value, $value))) . ' ' . HTML::attributes(
                                $option
                            ) . '>' . HTML::chars($_name, false) . '</option>';
                    }
                ...
                else
                {
                    ...
                    // Change the option to the HTML string
                    $options[$value] = '<option ' . (is_null($optionAttrsGenerator)
                            ? ''
                            : HTML::attributes($optionAttrsGenerator($value))) . ' ' . HTML::attributes($option) . '>'
                                       . HTML::chars($name, false) . '</option>';
                }
            }
