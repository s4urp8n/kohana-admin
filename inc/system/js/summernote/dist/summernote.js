    ...
    var h, i = {
        ...
        var b = function (b) {
            ...
            if (0 === a.offset) {
                ...
                _(a.node) ? (d = a.node.childNodes[a.offset - 1], e = F(d)) : (d = a.node, e = c ? 0 : a.offset - 1);
            }
            return {
                node: d,
                offset: e
            ...
            if (F(a.node) === a.offset) {
                ...
                _(a.node) ? (d = a.node.childNodes[a.offset], e = 0) : (d = a.node, e = c ? F(a.node) : a.offset + 1);
            }
            return {
                node: d,
                offset: e
        ...
        var b = function (a, b) {
            ...
            var b = function (a, c) {
                ...
                if (n.isText(a)) {
                    ...
                    if (d = a.childNodes[c] || a, n.isText(d)) {
                        return b(d, 0);
                    }
                    c = 0, e = !1
                }
            ...
            this.getPoints = function () {
                ...
                var a = function (a, b) {
                    if (n.isVisiblePoint(a) && !n.isEdgePoint(a) || n.isVisiblePoint(a) && n.isRightEdgePoint(a) && !b || n.isVisiblePoint(a) && n.isLeftEdgePoint(a) && b || n.isVisiblePoint(a) && n.isBlock(a.node) && n.isEmpty(a.node)) {
                        return a;
                    }
            ...
            this.isOnEditable = l(n.isEditable), this.isOnList = l(n.isList), this.isOnAnchor = l(n.isAnchor), this.isOnCell = l(n.isCell), this.isLeftEdgeOf = function (a) {
                if (!n.isLeftEdgePoint(this.getStartPoint())) {
                    return !1;
                }
                ...
                if (n.isBodyContainer(b) && n.isEmpty(b)) {
                    return b.innerHTML = n.emptyPara, new d(b.firstChild, 0, b.firstChild, 0);
                }
                var a = this.normalize();
                if (n.isParaInline(b) || n.isPara(b)) {
                    return a;
                }
                var c;
                if (n.isInline(a.sc)) {
                    ...
                    c = a.sc.childNodes[a.so > 0 ? a.so - 1 : 0];
                }
        ...
        var b = function (b) {
            ...
            return a.Deferred(function (d) {
                ...
                }).css({display: "none"}).appendTo(document.body).attr({
                                                                           src: b,
                                                                           "data-filename": c
                                                                       })
            }).promise()
        ...
        this.fromNode = function (a) {
            ...
            if (b.isCollapsed()) {
                return [b.insertNode(n.create(d))];
            }
        ...
        this.fontSize = function (b, c) {
            ...
            if (e.isCollapsed()) {
                ...
                l(b), a(d.styleNodes(e)).css({"font-size": c + "px"}), m(b)
            }
    ...
    var G = function (a) {
        ...
        this.attach = function (a, b) {
            ...
            c.on("dragenter", function (a) {
                ...
                if (d && d.files && d.files.length) {
                    c.preventDefault(), e.editable().focus(), b.insertImages(e, d.files);
                } else {
                    for (var f = function () {
        ...
        var h = function (a) {
            ...
            if (d.length) {
                ...
                if (j && d.parents(".popover").hide(), a.isFunction(a.summernote.pluginEvents[g])) {
                    a.summernote.pluginEvents[g](b, c.editor, l, i);
                } else if (c.editor[g]) {
                    var o = l.editable();
                    o.focus(), c.editor[g](o, i, f), b.preventDefault()
                } else {
                    e[g] && (e[g].call(this, l), b.preventDefault());
                }
        ...
        this.bindKeyMap = function (b, d) {
            ...
            g.on("keydown", function (h) {
                ...
                if (m) {
                    if (k = a.summernote.pluginEvents[l], a.isFunction(k) && k(h, c.editor, b)) {
                        return !1;
                    }
                    ...
                    r.isEdit(h.keyCode) && c.editor.afterCommand(g)
                }
            })
        }, this.attach = function (a, b) {
        ...
        this.createLayoutByAirMode = function (b, c) {
            ...
            if (b.length) {
                return b.data("holder", a), n.buildLayoutInfo(b)
            }
