    ...
    jQuery.fn.extend({
        ...
        return t.prototype.destroy = function () {
            ...
            for (s = this.picker_options, l = [], e = 0, i = s.length; i > e; e++) {
                t = s[e], t.is_selected() ? l.push(t.mark_as_selected()) : l.push(t.unmark_as_selected());
            }
            return l
            ...
            for (a = t.children("optgroup"), r = 0, o = a.length; o > r; r++) {
                n = a[r], n = jQuery(n), s = jQuery("<ul></ul>"), s.append(jQuery("<li class='group_title'>" + n.attr("label") + "</li>")), i.append(jQuery("<li>").append(s)), this.recursively_parse_option_groups(n, s);
            }
            for (p = function () {
                var i, s, n, r;
                for (n = t.children("option"), r = [], i = 0, s = n.length; s > i; i++) {
                    l = n[i], r.push(new e(l, this, this.opts));
                }
                return r
            }.call(this), u = [], c = 0, h = p.length; h > c; c++) {
                l = p[c], this.picker_options.push(l), l.has_image() && u.push(i.append(l.node));
            }
            return u
